...
const AIModels = () => {
  ...
  const handleDeleteConfirm = async () => {
    ...
    setSaving(true);
    try {
      await deleteModel(String(modelToDelete));
  ...
  const handleToggleStatus = async (
    ...
    try {
      await toggleModelStatus(String(modelId));
      setModels(
        models.map((model) =>
          model.id === modelId
  ...
  const handleTestModel = async () => {
    ...
    try {
      const result = await testModel(String(activeModel), testQuery);
                      ...
                      <CardContent className="space-y-6">
                        <div className="grid gap-6 md:grid-cols-2">
                          <div className="space-y-2">
                            ...
                            <Input
                              id="apiEndpoint"
                              value={model.parameters?.api_endpoint || ""}
                              readOnly
                            />
                          </div>
                          <div className="space-y-2">
                          ...
                          <div className="grid gap-6 md:grid-cols-2">
                            <div className="space-y-2">
                              ...
                              <div className="flex items-center gap-4">
                                ...
                                <span className="w-12 text-center">
                                  {model.parameters?.temperature?.toFixed(
                                    1,
                                  ) || "0.7"}
                                </span>
                              </div>
                            ...
                            <div className="space-y-2">
                              ...
                              <Input
                                id="maxTokens"
                                type="number"
                                defaultValue={model.parameters?.max_tokens || 1024}
                                readOnly
                              />
                              <p className="text-xs text-muted-foreground">
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="flex items-center gap-4">
                                ...
                                />
                                <span className="w-12 text-center">
                                  {model.parameters?.top_p?.toFixed(
                                    2,
                                  ) || "0.90"}
                                </span>
                              </div>
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="flex items-center gap-4">
                                ...
                                />
                                <span className="w-12 text-center">
                                  {model.parameters?.presence_penalty?.toFixed(
                                    1,
                                  ) || "0.0"}
                                </span>
                              </div>
